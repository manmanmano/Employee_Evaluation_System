...
<html lang="en">
    ...
    <body>
        ...
        <table>
            <tr>
                Name:
                <?php setcookie("name", $_GET['name'], time() + 3600, "/~juprus/icd0007_project"); echo $_GET['name']; ?>
                Week:
                <?php setcookie("week", $_GET['week'], time() + 3600, "/~juprus/icd0007_project"); echo $_GET['week']; ?>
                Year:
                <?php setcookie("year", $_GET['year'], time() + 3600, "/~juprus/icd0007_project"); echo $_GET['year']; ?>
            </tr>
            <tr>
                <th>Performance</th>
                <th>Never</th>
